...
public:
  ...
  wxDataViewItem replace(wxDataViewItem item, const MQTT::Message &message);
...
private:
  ...
  [[nodiscard]] bool isLeaf(const Common::fs::directory_entry &entry
  ) const override;
